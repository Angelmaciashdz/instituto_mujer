...
<html lang="es">
<head>
  <title>Ver programa - Instituto Municipal de la mujer</title>
  <meta charset="UTF-8">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-xs-12 col-md-10 col-md-offset-1">
                      <form class="frm-inscripcion" id="frm-inscripcion" action="?c=Programa&a=Actualiza" method="post" enctype="multipart/form-data">

                        <input class="form-control" type="hidden" name="id_programa" value="<?php echo $alm->__GET('id_programa')?>">
                       <center> <img class="img-responsive img-circle" src="..\..\public\imagenes\programas\<?php echo $alm->__GET('imagen');?>" style="margin-top: -5px;width: 80px; height: 80px;"  /></center>
                          <fieldset class="text-center col-md-12"><h1 style="text-transform: uppercase;"><strong><?php echo $alm->__GET('programa')?></string></h1></fieldset>
                      <div class="form-group col-md-4 label-floating">
                        ...
                        <input class="form-control" type="text" required name="folio_programa" value="<?php echo $alm->__GET('folio_programa')?>">

                      </div>
                       <div class="form-group col-md-4 label-floating">
                        <label class="control-label" style="color: black;"><i class="fa fa-tasks"> Programa</i></label>
                        <input class="form-control" type="text" required name="programa" value="<?php echo $alm->__GET('programa')?>">
                      </div>
                      <div class="form-group col-md-4 label-floating">
                            <label class="control-label" style="color: black;"><i class="fa fa-tasks">Tipo</i></label>
                         <select class="form-control" type="text" required name="tipo_programa">
                            <option value="<?php echo $alm->__GET('tipo_programa')?>" ><?php echo $alm->__GET('tipo')?></option>
                            <?php
                      ...
                      <div class="form-group col-md-4 label-floating">
                        ...
                        <input class="form-control text-uppercase" id="fecha_inicio" name="fecha_inicio" type="text" value="<?php echo $alm->__GET('fecha_inicio');?>" required>
                      </div>
                      <div class="form-group col-md-4 label-floating">
                        <label class="control-label" style="color: black;"><i class="fa fa-address-card"> Fecha termina</i></label>
                        <input class="form-control text-uppercase" id="fecha_termina" name="fecha_termina" type="text" value="<?php echo $alm->__GET('fecha_termina');?>" required>
                      </div>
                      <div class="form-group col-md-4 label-floating">
                        <label class="control-label" style="color: black;"><i class="zmdi zmdi-face">Imparte</i></label>
                        <input class="form-control" type="text" name="imparte" value="<?php echo $alm->__GET('imparte');?>">
                      </div>
                        <p class="text-right col-md-6">
                          <button href="#!" class="btn btn-success btn-raised btn-sm" onclick="validar();"><i class="zmdi zmdi-floppy"></i> Actualizar</button>
                        </p>
                      </form>
