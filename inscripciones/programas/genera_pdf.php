...
<html lang="es">
<head>
	<title>Pdf - Instituto Municipal de la mujer</title>
	<meta charset="UTF-8">
...
<?php include '../elements/nav.html'; ?>
		<div class="container-fluid">
			<div class="page-header">
			  ...
			  <div class="col-md-8"><h1 class="text-titles"><center><h1><strong>Instituto Municipal de la Mujer</strong></center></h1></center></h1>
			  	</div>
			  	<div class="col-md-2">
							...
							<div class="container-fluid">
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form name="verifica" action="?c=Programa&a=DescPdf" method="POST">

									    	<fieldset class="text-center"><h1><strong><i class="fa fa-file-pdf-o"></i> GENERAR PDF</strong></h1></fieldset>
                           ...
                           <?php
                            ...
                            <?php endforeach;?>
										    ...
										    <p class="text-center col-md-12">
										    	<button href="#!" style="margin-bottom: 50px;" class="btn btn-success btn-raised btn-sm" formtarget="_blank"><i class="zmdi zmdi-file"></i> GENERAR</button>
										    </p>
									    </form>
									</div>
								</div>
